...
// Package embedded registers the anthropic-decoder plugin with the Envoy dynamic module SDK.
package embedded

import (
	sdk "github.com/envoyproxy/envoy/source/extensions/dynamic_modules/sdk/go"

	impl "github.com/tetratelabs/built-on-envoy/extensions/composer/anthropic-decoder"
)

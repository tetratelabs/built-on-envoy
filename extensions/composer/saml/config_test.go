...
func TestParseConfig_URLMode(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":            "https://sp.example.com",
		"acs_path":             "/saml/acs",
	...
	require.Equal(t, defaultIDPMetadataFetchDelay, cfg.IDPMetadataFetchDelay)
	require.Equal(t, defaultIDPMetadataFetchMaxAttempts, cfg.IDPMetadataFetchMaxAttempts)
	// SP cert is auto-generated when not provided.
	require.True(t, cfg.SPCertAutoGenerated)
}

func TestParseConfig_URLMode_MaxAttemptsOverride(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                       "https://sp.example.com",
		"acs_path":                        "/saml/acs",
		"idp_metadata_url":                "https://idp.example.com/metadata",
	...
	cfg, err := parseConfig(data)
	require.NoError(t, err)
	require.Equal(t, 5, cfg.IDPMetadataFetchMaxAttempts)
}

func TestParseConfig_URLMode_MaxAttemptsZero_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                       "https://sp.example.com",
		"acs_path":                        "/saml/acs",
		"idp_metadata_url":                "https://idp.example.com/metadata",
		"idp_metadata_cluster":            "idp_cluster",
		"idp_metadata_fetch_max_attempts": 0,
	})
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_fetch_max_attempts")
}

func TestParseConfig_URLMode_MaxAttemptsNegative_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                       "https://sp.example.com",
		"acs_path":                        "/saml/acs",
		"idp_metadata_url":                "https://idp.example.com/metadata",
		"idp_metadata_cluster":            "idp_cluster",
		"idp_metadata_fetch_max_attempts": -1,
	})
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_fetch_max_attempts")
...
func TestParseConfig_MaxAttemptsWithoutURL_Error(t *testing.T) {
	idpKP := generateTestKeyPair("idp.example.com")
	idpMeta := testIDPMetadataXML("https://idp.example.com", "https://idp.example.com/sso", idpKP.Cert)
	...
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_fetch_max_attempts requires idp_metadata_url")
}

func TestParseConfig_URLMode_FetchDelayOverride(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                "https://sp.example.com",
		"acs_path":                 "/saml/acs",
		"idp_metadata_url":         "https://idp.example.com/metadata",
	...
	cfg, err := parseConfig(data)
	require.NoError(t, err)
	require.Equal(t, 10*time.Second, cfg.IDPMetadataFetchDelay)
}

func TestParseConfig_URLMode_FetchDelayInvalid_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                "https://sp.example.com",
		"acs_path":                 "/saml/acs",
		"idp_metadata_url":         "https://idp.example.com/metadata",
		"idp_metadata_cluster":     "idp_cluster",
		"idp_metadata_fetch_delay": "not-a-duration",
	})
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_fetch_delay")
}

func TestParseConfig_URLMode_FetchDelayNegative_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":                "https://sp.example.com",
		"acs_path":                 "/saml/acs",
		"idp_metadata_url":         "https://idp.example.com/metadata",
		"idp_metadata_cluster":     "idp_cluster",
		"idp_metadata_fetch_delay": "-1s",
	})
	_, err := parseConfig(data)
	require.Error(t, err)
...
func TestParseConfig_FetchDelayWithoutURL_Error(t *testing.T) {
	idpKP := generateTestKeyPair("idp.example.com")
	idpMeta := testIDPMetadataXML("https://idp.example.com", "https://idp.example.com/sso", idpKP.Cert)
	...
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_fetch_delay requires idp_metadata_url")
}

func TestParseConfig_URLAndInline_Error(t *testing.T) {
	idpKP := generateTestKeyPair("idp.example.com")
	idpMeta := testIDPMetadataXML("https://idp.example.com", "https://idp.example.com/sso", idpKP.Cert)
...
func TestParseConfig_NoMetadata_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id": "https://sp.example.com",
		"acs_path":  "/saml/acs",
	})
...
func TestParseConfig_URLWithoutCluster_Error(t *testing.T) {
	data, _ := json.Marshal(map[string]any{
		"entity_id":        "https://sp.example.com",
		"acs_path":         "/saml/acs",
		"idp_metadata_url": "https://idp.example.com/metadata",
	...
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_cluster is required")
}

func TestParseConfig_ClusterWithoutURL_Error(t *testing.T) {
	idpKP := generateTestKeyPair("idp.example.com")
	idpMeta := testIDPMetadataXML("https://idp.example.com", "https://idp.example.com/sso", idpKP.Cert)
	...
	_, err := parseConfig(data)
	require.Error(t, err)
	require.Contains(t, err.Error(), "idp_metadata_cluster requires idp_metadata_url")
}

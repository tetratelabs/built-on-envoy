...
| `BOE_REGISTRY` | OCI registry URL to fetch the extension from. | `ghcr.io/tetratelabs/built-on-envoy` |
| `BOE_REGISTRY_INSECURE` | Allow fetching from an insecure (HTTP) registry. | `false` |

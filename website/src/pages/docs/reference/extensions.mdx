...
[↑ Top](#) | [↑ DNS Gateway Lookup Configuration](#dns-gateway-lookup) {/* if .SubProperties */} {/* range .Properties */} {/* if .CustomTypes */}




<a id="dns-gateway-resolver"></a>
...
[↑ Top](#) | [↑ DNS Gateway Resolver Configuration](#dns-gateway-resolver)



#### domains.base_ip

Base IPv4 address for virtual IP allocation (e.g. "10.0.0.0").
...
[↑ Top](#) | [↑ DNS Gateway Resolver Configuration](#dns-gateway-resolver) {/* if .SubProperties */} {/* range .Properties */} {/* if .CustomTypes */}

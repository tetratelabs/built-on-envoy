...
Create a new extension with a single command:
...
Each callback returns a status that controls processing:
...
For more details about the different return values, refer to the [Dynamic Modules Go SDK](https://github.com/envoyproxy/envoy/tree/main/source/extensions/dynamic_modules/sdk/go).

...
func (r *Run) Run(ctx context.Context, dirs *xdg.Directories, logger *slog.Logger) error {
	...
	// TODO: Support oci:// URLs in run by passing registry credentials to
	// the goplugin loader via GOPLUGIN_PULL_SECRET and GOPLUGIN_INSECURE env vars.
	// For now, run always uses file:// URLs pointing to the locally cached binaries.
	// oci:// URLs are only generated by gen-config.

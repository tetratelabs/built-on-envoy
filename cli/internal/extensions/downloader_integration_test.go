...
func TestCheckOrDownloadComposer(t *testing.T) {
	...
	assert.ErrorContains(t, CheckOrDownloadLibComposer(t.Context(), downloader, "unexisting", ComposerArtifactLite), "not found") //nolint: testifylint
	assert.NoError(t, CheckOrDownloadLibComposer(t.Context(), downloader, "1.2.3", ComposerArtifactLite))                         //nolint: testifylint
